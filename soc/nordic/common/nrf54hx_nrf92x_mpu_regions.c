...
#define I3C120_BASE	DT_REG_ADDR_BY_NAME(DT_NODELABEL(i3c120), core)
#define I3C120_SIZE	DT_REG_SIZE_BY_NAME(DT_NODELABEL(i3c120), core)

#define I3C121_BASE	DT_REG_ADDR_BY_NAME(DT_NODELABEL(i3c121), core)
#define I3C121_SIZE	DT_REG_SIZE_BY_NAME(DT_NODELABEL(i3c121), core)
...
#endif
#if DT_NODE_HAS_STATUS(DT_NODELABEL(i3c120), okay)
	MPU_REGION_ENTRY("I3C120_CORE", I3C120_BASE,
			 REGION_RAM_NOCACHE_ATTR(I3C120_BASE, I3C120_SIZE)),
#endif
#if DT_NODE_HAS_STATUS(DT_NODELABEL(i3c121), okay)
	MPU_REGION_ENTRY("I3C121_CORE", I3C121_BASE,
			 REGION_RAM_NOCACHE_ATTR(I3C121_BASE, I3C121_SIZE)),
#endif
};
